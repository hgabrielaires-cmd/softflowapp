    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 translate-x-full h-6 w-4 flex items-center justify-center rounded-r-md text-sidebar-foreground/60 hover:text-sidebar-foreground transition-colors z-10"
