      ...
      <DialogContent className="max-w-md" onInteractOutside={(e) => e.preventDefault()}>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea placeholder="Descreva o motivo para pausar o projeto..." value={motivo} onChange={(e) => setMotivo(e.target.value)} rows={3} />
          </div>
          <div className="space-y-2">
        ...
        <DialogFooter>
          ...
          <Button className="bg-amber-600 hover:bg-amber-700 text-white" onClick={onConfirm} disabled={!motivo.trim() || loading}>
