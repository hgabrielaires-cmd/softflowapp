// ─── Autenticação compartilhada (sistema + usuário logado) ────────────────
// Regra: FAIL CLOSED. Nunca aceitar anon key. Aceita service_role, CRON_SECRET
// (env ou cofre do banco) ou QUALQUER usuário autenticado com JWT válido.
...
export async function authorizeSistema(req: Request): Promise<AuthResult> {
