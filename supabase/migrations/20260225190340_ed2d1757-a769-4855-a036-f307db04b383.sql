...
-- Add etapa_inicial_id to filiais
ALTER TABLE public.filiais ADD COLUMN etapa_inicial_id uuid REFERENCES public.painel_etapas(id) ON DELETE SET NULL;

-- Update trigger to use filial's configured initial stage
